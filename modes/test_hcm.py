...
def run_test_hcm(hparams):
    ...
    loaded_model = torch.load('/vault/datasets/khalil/EndToEndQA/models/hcm_no_match_loss_endtoendqa_best_loss=51.49.pt')
    #loaded_model = torch.load('/vault/datasets/khalil/EndToEndQA/models/hcm_coeff_0.01_endtoendqa_best_loss=55.25.pt')
    ...
    output_file = open('hcm_ref_as_gen.txt', 'w')
    output_file2 = open('hcm_gen.txt', 'w')

    ref_file = open('hcm_ref_for_annotation.tsv', 'w')
    match_file = open('hcm_mat_for_annotation.tsv', 'w')
    ...
    SELECTED_IDX = set([2,3,6,7,8,9,10,18,19,20,22,23,26,27,33,36,38,39,41,42,45,
                        57,58,60,63,65,66,67,74,75,80,83,86,87,88,101,103,107,110,
                        113,115,120,121,124,129,132,133,141,147,150,160,164])
